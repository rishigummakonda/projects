setwd("~/OneDrive - Lehigh University/r_code/bis448/bis448_labs")

##data summary and visualization
housing.df <- read.csv("~/OneDrive - Lehigh University/r_code/bis448/bis448_datasets/WestRoxbury.csv", header = TRUE)  # load data
...
##=============================================
## Boston housing data
housing.df <- read.csv("~/OneDrive - Lehigh University/r_code/bis448/bis448_datasets/BostonHousing.csv")
...
plot(housing.df$TOTAL.VALUE, housing.df$LIVING.AREA)
